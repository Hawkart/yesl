                            ...
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                    ...
                                    <p style="{{ $style['paragraph'] }}">
                                        As we can see, you have started the registration process on our website
                                        https://CampusTeam.tv/ <br>
                                        To complete it, all you need to do is to click the button below in order
                                    ...
                                    <table style="{{ $style['body_action'] }}" align="center" width="100%" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center">
                                                ...
                                                <a href="{{ url('register/verify/'.$user->confirmation_code) }}"
