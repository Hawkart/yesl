<template>
    <div class="ui-block">
        <div class="ui-block-title">
            <h6 class="title">Create gamer profile</h6>
            ...
            <form @submit.prevent="save" @keydown="form.onKeydown($event)">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    <div class="form-group required">
                        ...
                        <select v-model="form.game_id" name="game_id" class="form-control"  :class="{ 'is-invalid': form.errors.has('game_id') }" @change="selectGame">
